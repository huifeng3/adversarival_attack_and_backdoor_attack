...
def get_arguments():
    ...
    parser.add_argument("--schedulerC_milestones", type=list, default=[100,100,100,100])
    parser.add_argument("--schedulerC_lambda", type=float, default=0.1)
    parser.add_argument("--n_iters", type=int, default=1000)
    parser.add_argument("--num_workers", type=float, default=6)  #进程数
    ...
    parser.add_argument("--s", type=float, default=0.5) #扰动场强度
    parser.add_argument("--k", type=int, default=4)   #扰动场大小
    parser.add_argument(
